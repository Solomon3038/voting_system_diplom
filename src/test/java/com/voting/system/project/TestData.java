...
public class TestData {
    ...
    public static final User USER_1 = new User(USER_ID_1, "User One", "user.one@ukr.net", "password", Role.USER);
    public static final User USER_2 = new User(USER_ID_2, "User Two", "user.two@ukr.net", "password", Role.USER);
    public static final User ADMIN_1 = new User(ADMIN_ID_1, "Admin One", "admin.one@gmail.com", "admin", Role.ADMIN);
    public static final User ADMIN_2 = new User(ADMIN_ID_2, "Admin Two", "admin.two@gmail.com", "admin", Role.ADMIN);
